...
export async function exportConversationToPDF(
  ...
  for (const message of messages) {
    ...
    html += `
      <div style="margin-bottom: 24px; padding: 16px; border-radius: 12px; background: ${isUser ? "#f5f5f5" : "#fef2f2"};">
        ...
        <div style="line-height: 1.6; color: #1a1a1a; font-size: 14px;">
  ...
  html += `
    <div style="margin-top: 40px; padding-top: 20px; padding-bottom: 40px; margin-bottom: 40px; border-top: 1px solid #e5e5e5; color: #999; font-size: 12px; text-align: center;">
