				...
				<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					...
					>
						...
						<p className="mx-auto max-w-2xl text-muted-foreground">
							Have questions about our AI Executive Team? We'd love to hear from you.
								...
								<div className="flex items-start gap-4">
									...
									<div>
										...
										<p className="mb-4 text-sm text-muted-foreground">
											Get instant strategic advice from Alexandria (CMO) and Kim (CSO).
											Available 24/7 for sales and marketing consulting.
										</p>
										<a href="/login">
							...
							<div className="rounded-2xl border border-border/50 bg-white/80 p-6 shadow-lg backdrop-blur-sm dark:bg-neutral-900/80">
								...
								<ul className="space-y-3 text-sm text-muted-foreground">
									<li className="flex items-start gap-2">
										...
										<span>
											<strong className="text-foreground">Free trial?</strong> Yes! Start with 50 free messages to test our AI executives.
										</span>
									</li>
									<li className="flex items-start gap-2">
										<span className="mt-1 text-red-500">•</span>
										<span>
											<strong className="text-foreground">Enterprise plans?</strong> Contact us for custom pricing and features.
										</span>
									</li>
									<li className="flex items-start gap-2">
										<span className="mt-1 text-red-500">•</span>
										<span>
											<strong className="text-foreground">Data security?</strong> We use enterprise-grade encryption and never share your data.
										</span>
									</li>
								</ul>
							</div>
