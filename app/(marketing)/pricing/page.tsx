						...
						>
							...
							<div className="flex-1">
								...
								<p
									className={cn(
										"mt-0.5 text-xs",
										feature.highlight ? "text-red-600 font-semibold" : "text-stone-500"
									)}
								>
				...
				>
					...
					<div className="relative z-10 text-center">
						...
						<p className="mx-auto mt-4 max-w-lg text-stone-300">
							If you're not completely satisfied with your membership within the first 30
							days, we'll refund your payment in full. No questions asked. We're confident
							you'll love working with our AI executive team.
						</p>
					</div>
				</motion.div>
			</div>
				...
				<div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
					...
					>
						...
						<p className="mx-auto mt-6 max-w-2xl text-lg text-stone-600">
							...
							traditional consulting costs. Choose the plan that works best for you.
						</p>
					</motion.div>
				</div>
			</section>
