...
export function Weather({
	...
	// Always render 6 hours, use CSS to hide the last on mobile for consistent SSR/hydration
	const hoursToShow = 6;
				...
				<div className="rounded-2xl bg-white/10 p-4 backdrop-blur-sm">
					...
					<div className="flex justify-between gap-2">
						{displayTimes.map((time, index) => {
							...
							// Hide 6th hour on mobile for responsive layout (CSS-based, not JS)
							const isLastHour = index === 5;
