	...
	return (
		<div className="flex h-full flex-col">
			...
			<div className="flex items-center justify-between border-b border-border/60 px-3 py-2">
				<span className="font-medium text-xs text-muted-foreground">Strategy Canvas</span>
				<Link
				...
				return (
					...
					>
						<div className="mb-2 flex items-center justify-between sm:mb-3">
							<div>
								<h3 className="font-semibold text-xs sm:text-sm">{quadrant.label}</h3>
	...
	return (
		<div className="min-h-[120px] rounded-lg border border-border bg-background p-2 sm:min-h-[150px] sm:p-3">
			<div className="mb-1.5 flex items-center justify-between sm:mb-2">
				<h4 className="font-medium text-[10px] leading-tight sm:text-xs">{label}</h4>
				<button
					type="button"
					onClick={onAdd}
